...
namespace PanFlow.API.Migrations
{
    ...
    [Migration("20260726150915_lastGa")]
    partial class lastGa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PanFlow.API.Models.Aspect", b =>
                {
                    b.Property<string>("AspectId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("AspectColor")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PanFlow.API.Models.DayHabit", b =>
                {
            ...
            modelBuilder.Entity("PanFlow.API.Models.Habit", b =>
                {
                    b.Property<string>("HabitId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PanFlow.API.Models.DayHabit", b =>
                {
                    b.HasOne("PanFlow.API.Models.Day", "Day")
                        .WithMany("DayHabits")
                        .HasForeignKey("DayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PanFlow.API.Models.Habit", "Habit")
                        .WithMany("DayHabits")
            ...
            modelBuilder.Entity("PanFlow.API.Models.Habit", b =>
                {
                    b.HasOne("PanFlow.API.Models.Aspect", "Aspect")
                        .WithMany("Habits")
