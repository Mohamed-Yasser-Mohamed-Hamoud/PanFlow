    ...
    public partial class create : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AspectId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AspectName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AspectColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Aspects_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Habits_Aspects_AspectId",
                        column: x => x.AspectId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DayHabits", x => new { x.HabitId, x.DayId });
                    table.ForeignKey(
